...
{
  plot(povprecje$imena_meseci2, povprecje$povprecje_ozon_meseci, type = "l", col = "red", xlab = "Mesec", ylab = "Vrednost ozona ter PM10 delcev", main = "Povprečje ozona in PM10 delcev glede na mesec", ylim = c(0,140))
